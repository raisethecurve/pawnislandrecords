window.PAWN_PUBLIC_DATA = {
  ...
  "artists": [
    ...
    },
    {
      ...
      "summary": "Pop-punk for no-manual moments: overdue decisions, hard exits, and refusing the role somebody else wrote.",
      "headline": "Pop-punk for no-permission exits and title-first songs that move like deadlines.",
      "story": "Blackout State uses sharp titles and compact pop-punk momentum: No Manual, No Master rejects the rulebook; High Time makes waiting feel impossible.",
      ...
      "pressBio": "Blackout State is Pawn Island Records' pop-punk project. No Manual, No Master sets its core posture: no instruction sheet, no owner, no permission structure. High Time pushes that same refusal into a compact deadline of a single.",
      "pressHighlights": [
  ...
  "releases": [
    ...
    },
    {
      ...
      "description": "No Manual, No Master is the rulebook: no guide, no owner, no permission structure, just pop-punk pointed at the exit.",
      "status": "live",
      "releaseDate": "2026-02-05",
    ...
    },
    {
      ...
      "description": "High Time makes urgency the subject: the decision is overdue, the room is closing in, and the title lands like a command.",
      "status": "live",
